            ...
            <div id="main-chat" className=" form-container p-4 rounded in-chat">
              <div id="contacts-list" className="contacts-list">
                ...
                <ul className="list-unstyled chat-list mb-0" id="chat-list">
                  <ChatPreview img={three_pic} name="Otsmot its the best at 7 AM" date="Now!" />
                  <ChatPreview img={or_pic} name="Or haroni" date="Now!" />
                  <ChatPreview img={or_pic} name="Or haroni" date="Now!" />
                  <ChatPreview img={or_pic} name="Or haroni" date="Now!" />
                  <ChatPreview img={or_pic} name="Or haroni" date="Now!" />
                  <ChatPreview img={or_pic} name="Or haroni" date="Noasdasdasdsadasdasdasdasdasdasdasdsadasdw!" />
                </ul>           
              </div>
              <div id="chat" className="chat-container">
                ...
                <div id="active-chat" className="chat-history">
                  ...
                  <Message sender="me" messegeText="Im am second" img={or_pic}/>
                  <Message sender="Naor" messegeText="Heyasdsafast" img={naor_pic}/>
                  </ul>
                </div>
                <div id="send-area">
